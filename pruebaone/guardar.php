...
<?php
    $usuario = "sql10395316"; //en ste caso root por ser localhost
    $password = "upDuEYCnEC";  //contraseña por si tiene algun servicio de hosting 
    $servidor = "sql10.freesqldatabase.com"; //localhost por lo del xampp
    $basededatos ="sql10395316"; //nombre de la base de datos
